...
namespace ProyectoProgramacionAvanzadaWebApi.Models
{
    public class Usuarios
    {
        ...
        public string? Identificacion { get; set; } //Valor unique en la base de datos
        ...
        public string? Email { get; set; } //Valor unique en la base de datos
        ...
        public string? Telefono { get; set; } //Valor unique en la base de datos
