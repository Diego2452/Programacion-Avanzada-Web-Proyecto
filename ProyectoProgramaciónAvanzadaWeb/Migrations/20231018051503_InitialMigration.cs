        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TipoFinanciamiento = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UbicacionEmpresa = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CorreoEmpresa = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NumeroTelefonoEmpresa = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MarcasProveedor = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "HistorialCompraCarros",
                columns: table => new
                {
                    IdHistorialCompraCarro = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdUsuario = table.Column<int>(type: "int", nullable: false),
                    IdCarro = table.Column<int>(type: "int", nullable: false),
                    Descripcion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    Estado = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UsuarioIdUsuario = table.Column<int>(type: "int", nullable: false),
                    CarroIdCarro = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HistorialCompraCarros", x => x.IdHistorialCompraCarro);
                    table.ForeignKey(
                        name: "FK_HistorialCompraCarros_Carros_CarroIdCarro",
                        column: x => x.CarroIdCarro,
                        principalTable: "Carros",
                        principalColumn: "IdCarro",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HistorialCompraCarros_Usuarios_UsuarioIdUsuario",
                        column: x => x.UsuarioIdUsuario,
                        principalTable: "Usuarios",
                        principalColumn: "IdUsuario",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistorialCompraCarros_CarroIdCarro",
                table: "HistorialCompraCarros",
                column: "CarroIdCarro");

            migrationBuilder.CreateIndex(
                name: "IX_HistorialCompraCarros_UsuarioIdUsuario",
                table: "HistorialCompraCarros",
                column: "UsuarioIdUsuario");
